...
var mLayout = function() {
    ...
    // Begin of menu 2
    var initLeftAsideMenu2 = function() {
        var menu2 = $('#m_ver_menu2');
        ...
        var menuOptions2 = {  
            ...
            submenu: {
                desktop: {
                    // by default the menu mode set to accordion in desktop mode
                    default: (menu2.data('menu-dropdown') == true ? 'dropdown' : 'accordion'),
                    // whenever body has this class switch the menu mode to dropdown
                    state: {
                        body: 'm-aside-left--minimize',  
                        mode: 'dropdown'
        ...
        asideMenu2 = menu2.mMenu(menuOptions2);

        // handle fixed aside menu
        if (menu2.data('menu-scrollable')) {
            function initScrollableMenu(obj) {    
                if (mUtil.isInResponsiveRange('tablet-and-mobile')) {
                    // destroy if the instance was previously created
                    mApp.destroyScroller(obj);
    ...
    // Begin of menu 3
    // handle vertical menu
    var initLeftAsideMenu3 = function() {
        var menu6 = $('#m_ver_menu6');
        ...
        var menuOptions6 = {  
            ...
            submenu: {
                desktop: {
                    // by default the menu mode set to accordion in desktop mode
                    default: (menu6.data('menu-dropdown') == true ? 'dropdown' : 'accordion'),
                    // whenever body has this class switch the menu mode to dropdown
                    state: {
                        body: 'm-aside-left--minimize',  
                        mode: 'dropdown'
        ...
        asideMenu6 = menu6.mMenu(menuOptions6);

        // handle fixed aside menu
        if (menu6.data('menu-scrollable')) {
            function initScrollableMenu(obj) {    
                if (mUtil.isInResponsiveRange('tablet-and-mobile')) {
                    // destroy if the instance was previously created
                    mApp.destroyScroller(obj);
	 ...
	 var initLeftAsideMenu3 = function() {
        ...
        var menuOptions3 = {  
            ...
            submenu: {
                desktop: {
                    // by default the menu mode set to accordion in desktop mode
                    default: (menu3.data('menu-dropdown') == true ? 'dropdown' : 'accordion'),
                    // whenever body has this class switch the menu mode to dropdown
                    state: {
                        body: 'm-aside-left--minimize',  
                        mode: 'dropdown'
        ...
        asideMenu3 = menu3.mMenu(menuOptions3);

        // handle fixed aside menu
        if (menu3.data('menu-scrollable')) {
            function initScrollableMenu(obj) {    
                if (mUtil.isInResponsiveRange('tablet-and-mobile')) {
                    // destroy if the instance was previously created
                    mApp.destroyScroller(obj);
    ...
    // Begin of menu4
    // handle vertical menu
    var initLeftAsideMenu4 = function() {
        var menu = $('#m_ver_menu4');
        ...
        asideMenu4 = menu.mMenu(menuOptions4);
