    ...
    var demos = function() {
        ...
        $('#m_select2_4').select2({
            ...
            allowClear: true
		        ...
		        $('#m_select2_44').select2({
            placeholder: "Select a bank",
            allowClear: true
        });
		
				        $('#m_select2_444').select2({
            placeholder: "Select a collection",
            allowClear: true
        });
		
		 $('#m_select2_440').select2({
            placeholder: "Select a bank",
            allowClear: true
        });
        ...
        $('#m_select2_11').select2({
            placeholder: "New types..",
            tags: true
        });
		
		$('#m_select2_110').select2({
            placeholder: "Enter Tags",
            tags: true
        });

		$('#m_select2_1100').select2({
            placeholder: "Enter Tags",
            tags: true
        });
